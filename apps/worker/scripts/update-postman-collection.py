...
with open('/Users/sh/Sites/sheenapps-claude-worker/docs/POSTMAN_SheenApps-Claude_Worker_API.postman_collection-2-Aug-2025.json', 'r') as f:
    collection = json.load(f)

# Define the chat plan endpoints
chat_plan_endpoints = {
    "name": "Chat Plan Mode",
    "item": [
        {
...
# Find the index of "Error Examples" section
error_examples_index = None
for i, item in enumerate(collection['item']):
    if item.get('name') == 'Error Examples':
        error_examples_index = i
        break

# Insert chat plan endpoints before "Error Examples"
if error_examples_index is not None:
    collection['item'].insert(error_examples_index, chat_plan_endpoints)
else:
    # If not found, append at the end
    collection['item'].append(chat_plan_endpoints)

# Write the updated collection
with open('/Users/sh/Sites/sheenapps-claude-worker/docs/POSTMAN_SheenApps-Claude_Worker_API.postman_collection-2-Aug-2025.json', 'w') as f:
    json.dump(collection, f, indent=2)

print("✅ Postman collection updated successfully!")
print(f"✅ Added 'Chat Plan Mode' section with 7 endpoints")
print(f"✅ Added 'sessionId' variable to collection")
print("✅ All endpoints configured with HMAC signature generation")