-- Migration 027: Fix constraint/conflict mismatch in update_project_metrics_summary function
-- Date: August 1, 2025
-- Purpose: Fix ON CONFLICT clause to match the actual unique constraint
