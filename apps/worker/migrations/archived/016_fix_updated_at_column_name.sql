-- Fix stored procedure to use correct column name
-- The column is named project_last_updated, not updated_at
...
BEGIN
  ...
  DO UPDATE SET
    ...
    project_last_updated = CURRENT_TIMESTAMP;  -- Fixed: use correct column name
END;
$$ LANGUAGE plpgsql;