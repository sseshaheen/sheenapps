...
// GET /api/admin/inhouse/projects/[projectId]/search/queries/export
export async function GET(
  ...
  const path = `/v1/admin/inhouse/projects/${projectId}/search/queries/export${queryString ? `?${queryString}` : ''}`
