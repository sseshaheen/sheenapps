// ISO 3166-1 alpha-2 — full list used by domain registrars (sorted by name)
export const COUNTRIES = [
  ...
  { code: 'ZA', name: 'South Africa' }, { code: 'GS', name: 'South Georgia' },
  ...
  { code: 'UM', name: 'US Minor Outlying Islands' }, { code: 'UY', name: 'Uruguay' },
