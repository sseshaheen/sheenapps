-- Fix check_and_consume_quota function to work with the actual table structure
-- The usage_tracking table now has denormalized columns instead of metric_name/metric_value
...
-- Add comment
COMMENT ON FUNCTION check_and_consume_quota IS 'Atomic quota consumption with denormalized column structure';